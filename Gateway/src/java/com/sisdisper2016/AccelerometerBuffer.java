...
public class AccelerometerBuffer {
    ...
    public static AccelerometerBuffer getInstance() {
        if (instance == null) {
            instance = new AccelerometerBuffer();
        }
        return instance;
    }
